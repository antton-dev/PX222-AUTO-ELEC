...
D'après nos simulations, nous avons optimisé $\omega_i = \qty{36,95}{rad/s}$, ce qui impose un produit $R_{212} \cdot C_{211} \approx \qty{0,027}{s}$. En utilisant les valeurs standards disponibles au laboratoire, nous fixons :
\begin{itemize}
